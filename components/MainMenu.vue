...
<template>
  <div class="flex flex-col sm:flex-row bg-slate-900 px-4 rounded-lg text-white font-bold">
    ...
    <HeadlessMenu as="div" class="relative inline-block text-left" v-slot="{ open }">
      ...
      <HeadlessMenuItems
        class="relative sm:absolute -left-2 w-full sm:w-56 origin-top-right divide-y divide-slate-100 bg-slate-700 shadow-lg rounded-lg ring-1 ring-black ring-opacity-5 focus:outline-none"
      >
        <div class="px-1 py-1">
